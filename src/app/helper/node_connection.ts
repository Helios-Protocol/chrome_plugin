...
export class ConnectionMaintainer {
    ...
    availableNodes:any;
    web3:any;
    WSConnectTimeout:any;
    connectionFailureRetryPeriod:any;
    status:any;
    ...
    async connectToNetwork(){  
        ...
        if(this.isConnected()) {
            ...
            try {
                ...
                if (isConnected) {
                    // We connected.
                    this.setStatus('Connected to node ' + this.web3.currentProvider.connection.url + " on " +this.networkIDToName[this.networkId]);
